...
* `git clone git@github.com:rumblex/angularattack2016-nmpallete.git`

* `cd angularattack2016-nmpallete`
...
If you receive an error message `"You do not have permission to publish to nmpallete.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add it.treugott@gmail.com,fgarcia132@cnm.edu,tall.white.ninja@gmail.com,dmcdonald21@cnm.edu`
